...
$query = "SELECT * FROM peminjam WHERE nim = '$nim'";
...
$peminjam = mysqli_fetch_assoc($result); // $student adalah variable array yang berisi 1 data mahasiswa
...
<head>
    ...
    <title>Edit Mahasiswa - <?= $peminjam['nama']; ?></title>
        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                ...
                <form action="update.php" method="POST">
                    ...
                    <input type="hidden" name="nim_lama" value="<?= $peminjam['nim']; ?>">
                    <!-- kita perlu mengirimkan nim lama karena kita akan mengedit data berdasarkan nim lama -->
                    <div class="mb-3">
                        <label for="nim" class="form-label">NIM</label>
                        <input type="text" class="form-control" id="nim" name="nim" value="<?= $peminjam['nim']; ?>" readonly>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="alamat" name="alamat" rows="3"><?= $peminjam['alamat']; ?></textarea>
                    </div>
